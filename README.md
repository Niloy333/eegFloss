...
N. Sikder, P. Zerr, M. Jafarzadeh Esfahani, M. Dresler, & M. Krauledat, *eegFloss: A Python package for refining sleep EEG recordings using machine learning models* (submitted) [preprint](https://hochschule-rhein-waal.sciebo.de/s/rttTLfF9eRDSq4c).
